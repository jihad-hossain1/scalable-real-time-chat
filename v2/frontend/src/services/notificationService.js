...
const notificationService = {
  ...
  getHistory: async (params = {}) => {
    try {
      const response = await apiService.paginated('/notifications/history', params)
      return response
    } catch (error) {
  ...
  snoozeNotification: async (notificationId, duration) => {
    try {
      const response = await apiService.post(`/notifications/${notificationId}/snooze`, {
        duration
      })
      return response.data
    } catch (error) {
  ...
  unsnoozeNotification: async (notificationId) => {
    try {
      const response = await apiService.post(`/notifications/${notificationId}/unsnooze`)
      return response.data
    } catch (error) {
  ...
  updateRule: async (ruleId, updates) => {
    try {
      const response = await apiService.put(`/notifications/rules/${ruleId}`, updates)
      return response.data
    } catch (error) {
  ...
  getScheduledNotifications: async (params = {}) => {
    try {
      const response = await apiService.paginated('/notifications/scheduled', params)
      return response
    } catch (error) {
  ...
  bulkMarkAsRead: async (filters = {}) => {
    try {
      const response = await apiService.post('/notifications/bulk/read', filters)
      return response.data
    } catch (error) {
  ...
  updateDigestSettings: async (settings) => {
    try {
      const response = await apiService.put('/notifications/digest/settings', settings)
      return response.data
    } catch (error) {
  ...
  updateCategorySettings: async (categoryId, settings) => {
    try {
      const response = await apiService.put(`/notifications/categories/${categoryId}`, settings)
      return response.data
    } catch (error) {
  ...
  registerDevice: async (deviceData) => {
    try {
      const response = await apiService.post('/notifications/devices', deviceData)
      return response.data
    } catch (error) {
  ...
  updateDevice: async (deviceId, updates) => {
    try {
      const response = await apiService.put(`/notifications/devices/${deviceId}`, updates)
      return response.data
    } catch (error) {
