...
export const conversations = pgTable("conversations", {
  ...
  conversationType: varchar("conversation_type", { length: 20 }).default(
    "direct"
  ), // 'direct', 'group'
  groupId: uuid("group_id").default(null),
  isGroupConversation: boolean("is_group_conversation").default(false),
  conversationId: uuid("conversation_id").defaultRandom(), // direct message: user_id, group message: group_id
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
